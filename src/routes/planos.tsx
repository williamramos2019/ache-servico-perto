...
export const Route = createFileRoute("/planos")({
  head: () => ({
    meta: [
      { title: "Planos para anunciar — AgendaAqui" },
      { name: "description", content: "Escolha o plano ideal para destacar sua empresa no AgendaAqui e atrair mais clientes em Minas Gerais." },
      { property: "og:title", content: "Anuncie sua empresa no AgendaAqui" },
...
const PLANS = [
  {
    ...
    icon: Star,
    accent: false,
    features: ["Listagem padrão", "Página da empresa", "Receba avaliações", "Suporte por e-mail"],
  },
  {
    id: "profissional",
    name: "Profissional",
    ...
    icon: Zap,
    accent: true,
    features: ["Tudo do Básico", "Selo Verificado", "Posição prioritária", "Galeria de fotos ilimitada", "Estatísticas de visitas"],
  },
  {
    id: "premium",
    name: "Premium",
    ...
    icon: Crown,
    accent: false,
    features: ["Tudo do Profissional", "Selo Premium destacado", "Destaque na home", "Atendimento dedicado", "Campanhas de divulgação"],
  },
] as const;
