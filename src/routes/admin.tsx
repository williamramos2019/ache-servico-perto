...
import { LayoutDashboard, Building2, BadgePercent, Settings, Mail, Landmark, Siren, MapPin, Newspaper, CalendarDays, Menu as MenuIcon } from "lucide-react";
...
const NAV: { to: "/admin" | "/admin/empresas" | "/admin/servicos-publicos" | "/admin/emergencia" | "/admin/cidades" | "/admin/planos" | "/admin/leads" | "/admin/blog" | "/admin/eventos" | "/admin/menu" | "/admin/configuracoes"; label: string; icon: typeof LayoutDashboard; exact?: boolean }[] = [
