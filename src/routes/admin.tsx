...
import { LayoutDashboard, Building2, BadgePercent, Settings, Mail, Landmark, Siren, MapPin, Newspaper, CalendarDays, Menu as MenuIcon, Type, Bell, Bug, Copy, BadgeCheck } from "lucide-react";
...
const NAV: { to: "/admin" | "/admin/empresas" | "/admin/reivindicacoes" | "/admin/servicos-publicos" | "/admin/emergencia" | "/admin/cidades" | "/admin/planos" | "/admin/leads" | "/admin/blog" | "/admin/duplicados" | "/admin/eventos" | "/admin/menu" | "/admin/textos" | "/admin/push" | "/admin/qa" | "/admin/configuracoes"; label: string; icon: typeof LayoutDashboard; exact?: boolean }[] = [
