    ...
    <SiteLayout>
      <div className="container mx-auto flex max-w-md flex-col px-4 py-16">
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm md:p-8">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Entre para avaliar empresas, salvar seus favoritos e gerenciar o seu negócio.</p>
            ...
            <TabsContent value="signin" className="mt-4">
              <form onSubmit={signIn} className="space-y-3">
                ...
                <div>
                  ...
                  <Input id="pw" type="password" placeholder="Sua senha" value={password} onChange={(e) => setPassword(e.target.value)} required />
                </div>
                <Button type="submit" className="w-full" disabled={loading}>{loading ? "Entrando..." : "Entrar na minha conta"}</Button>
              </form>
            </TabsContent>
